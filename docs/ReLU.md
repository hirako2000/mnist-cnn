...
When [Alex Krizhevsky](https://en.wikipedia.org/wiki/Alex_Krizhevsky) built AlexNet for the 2012 ImageNet competition, Alex Krizhevsky used ReLU and was able to train an eight-layer network that outperformed all previous approaches. AlexNet's victory is credited with sparking the deep learning revolution.
